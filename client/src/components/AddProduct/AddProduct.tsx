  ...
  return (
    <Paper elevation={10} style={paperStyle}>
      ...
      >
        ...
        >
          <Avatar sx={{ bgcolor: "deepskyblue", width: 56, height: 56 }}>
            <AddIcon />
          </Avatar>
          <h1>Add Product</h1>
        </Box>
        <TextField
          ...
          helperText={
            error?.instrumentName?.hasError
              ? error.instrumentName.errorMessage
              : ""
          }
        />
        <TextField
          ...
          helperText={
            error?.description?.hasError ? error.description.errorMessage : ""
          }
        />
        <FormControl
          fullWidth
        ...
        >
          ...
          {error?.category?.hasError && (
            <FormHelperText>{error.category.errorMessage}</FormHelperText>
          )}
        </FormControl>
        <TextField
          {...price}
